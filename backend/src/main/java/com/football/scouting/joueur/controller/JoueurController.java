...
@Tag(name = "Joueur", description = "Gestion des joueurs")
public class JoueurController {
    ...
    public JoueurResponse createJoueur(@Valid @RequestBody JoueurRequest request) {
    ...
    @GetMapping("/{id}")
    public JoueurResponse getJoueurById(@PathVariable Long id) {
        return joueurService.getJoueurById(id);
    }

    @Operation(summary = "Mettre à jour un joueur")
    @PutMapping("/{id}")
    public JoueurResponse updateJoueur(@PathVariable Long id, @Valid @RequestBody JoueurRequest request) {
        return joueurService.updateJoueur(id, request);
    }
